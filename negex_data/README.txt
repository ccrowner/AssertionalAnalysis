...
The code for this project creates an output_file (the file is included in this folder negex_output.txt).
...
The README for Peter Kung's negex project is reproduced below:
